      ...
      <div className="w-full relative h-full  pt-[100px] px-16 ">
        ...
        <div className="w-full">
          ...
          <div className="grid w-full grid-row-1 cols-span-8">
              ...
              <RoadMapBox number="06" title="Initial Project researchand ideation" style="col-start-4 col-span-1 " />
              <RoadMapBox number="07" title="Initial Project researchand ideation" style="col-start-6 col-span-1 " />
          </div>
        </div>
      </div>
    </div>

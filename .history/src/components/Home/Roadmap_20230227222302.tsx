      ...
      <div className="w-full relative h-full  py-[60px] px-16 ">
        ...
        <div className="w-full">
          ...
          <div className="grid w-full grid-row-1 cols-span-8">
              <RoadMapBox number="02" title="Initial Project researchand ideation" style="col-start-2 col-span-1" position="bulb-one -bottom-4 left-[100px] />
              <RoadMapBox number="04" title="Initial Project researchand ideation" style="col-start-4 col-span-1" position="bulb-one -bottom-4 left-[100px]/>
              <RoadMapBox number="06" title="Initial Project researchand ideation" style="col-start-6 col-span-1" position="bulb-one -bottom-4 left-[100px]/>
          </div>
        </div>
      </div>
    </div>

...
export default function OurTeam() {
	return (
		<section className='relative w-full h-full bg-red-400 '>
			<div className='absolute bg-[url("/section_svg/section-team.svg")] bg-no-repeat w-full h-full' />
			<div className='relative w-full h-full pt-[120px] pb-[100px] px-16'>
				<div className='flex flex-col items-start gap-6 max-w-[601px]'>
					<h2 className='text-white text-[80px] leading-[80px] font-ruberoid font-extrabold'>Our Core Team</h2>
				...
				<div className='flex flex-row items-start gap-[56px] mt-[72px]'>
